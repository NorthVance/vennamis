...
export default function Home() {
  ...
  // 📍 FIX: Failsafe Render Avatar (If image breaks, show text initial)
            ...
            {filteredData.map(item => {
              ...
              return (
                <div key={item.id} onClick={() => setState(prev => ({ ...prev, activeModal: 'modal-gig-detail', selectedItem: item }))} className="btn-press bento-card rounded-[2rem] p-6 sm:p-8 cursor-pointer relative group">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-prime mb-3 leading-tight">{item.title}</h3><p className="text-sm sm:text-base text-sub mb-4 leading-relaxed font-medium">{item.desc}</p>

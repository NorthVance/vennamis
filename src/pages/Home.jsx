              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center pt-3 border-t border-[var(--border-line)] mt-3">
                  <div className="flex space-x-2 text-sub">
                    <button onClick={() => setState(prev => ({...prev, toast: {type:'info', message:'File upload coming soon.'}}))} className="btn-press p-2 hover:text-prime hover:bg-[var(--border-line)] rounded-xl transition"><i data-lucide="image" className="w-4 h-4"></i></button>
            ...
            {filteredData.map(item => {
                  ...
                  <div key={item.id} onClick={() => setState(prev => ({ ...prev, activeModal: 'modal-gig-detail', selectedItem: item }))} className="btn-press bento-card rounded-[2rem] p-6 sm:p-8 cursor-pointer flex flex-col justify-between h-[260px] group relative overflow-hidden">
                    ...
                    <div>
                      <div className="flex justify-between items-start mb-5">
                        ...
                        <button onClick={(e) => handleReport(e)} className="text-sub hover:text-red-500 opacity-0 group-hover:opacity-100 transition p-1"><i data-lucide="more-horizontal" className="w-5 h-5"></i></button>
                      </div>
                    ...
                    <div className="flex justify-between items-end mt-auto pt-5 border-t border-[var(--border-line)]/50">
                      ...
                      <button onClick={(e) => handleApply(e, item)} className="btn-press px-5 py-2.5 rounded-xl surface-bg border border-[var(--border-line)] flex items-center justify-center hover:border-[var(--primary-glow)] hover:text-[var(--primary-glow)] text-prime shadow-sm transition-all duration-300 font-bold text-xs gap-2">
              ...
              return (
                <div key={item.id} onClick={() => setState(prev => ({ ...prev, activeModal: 'modal-gig-detail', selectedItem: item }))} className="btn-press bento-card rounded-[2rem] p-6 sm:p-8 cursor-pointer relative group">
                  <button onClick={(e) => handleReport(e)} className="absolute top-6 right-6 text-sub hover:text-red-500 opacity-0 group-hover:opacity-100 transition p-1"><i data-lucide="more-horizontal" className="w-5 h-5"></i></button>
                  <div onClick={(e) => openProfile(e, item.host, item.avatar)} className="flex items-center space-x-4 mb-5 hover:opacity-80 transition cursor-pointer w-fit">

// ==========================================
// VENNAMIS GLOBAL STATE & DATA STORE
// ==========================================
...
export const sysTranslations = {
    en: { 
        ...
        title_feed: "Live Global Stream", antiScamTitle: "Secure Workspace Policy", 
        antiScamDesc: "To protect our community, please avoid sharing external links. All payments are secured via Escrow." 
    },
    th: { 
        nav_explore: "หางาน", nav_how: "วิธีใช้งาน", nav_safety: "ความปลอดภัย", 
        btn_post: "ลงประกาศ", badge_secure: "ระบบนิเวศระดับโลก", hero_static: "ค้นหาผู้เชี่ยวชาญด้าน", 
        hero_sub: "เชื่อมต่อกับมืออาชีพทั่วโลก พร้อมระบบสัญญาอัจฉริยะ", 
        title_feed: "กระดานอัปเดตล่าสุด", antiScamTitle: "นโยบายความปลอดภัย", 
        antiScamDesc: "เพื่อปกป้องชุมชนของเรา กรุณาหลีกเลี่ยงการแชร์ลิงก์ภายนอก การชำระเงินได้รับการคุ้มครองผ่านระบบ Escrow" 
    }
};
